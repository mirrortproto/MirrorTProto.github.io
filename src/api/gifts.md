...
Then, follow the [usual payment flow »](/api/payments/#22-getting-invoice-info-about-the-product).
...
If the `drop_original_details_stars` flag of [messageActionStarGiftUnique](/constructor/messageActionStarGiftUnique/)/[savedStarGift](/constructor/savedStarGift/) is set, this information can be removed by paying the amount of [stars](/api/stars/) specified in `drop_original_details_stars` using [inputInvoiceStarGiftDropOriginalDetails](/constructor/inputInvoiceStarGiftDropOriginalDetails/), passing it to the [usual payment flow »](/api/payments/#22-getting-invoice-info-about-the-product), along with an [InputSavedStarGift](/type/InputSavedStarGift/) pointing to the owned gift.
