...
section: ref
crumbs: [{"title":"API","url":"/api/"},{"title":"TL-schema","url":"/schema/"},{"title":"Bool","url":"/type/Bool/"}]
layout: layout.njk
---
...
<table class="table"><thead><tr><th scope="col">Constructor</th><th scope="col">Description</th></tr></thead><tbody><tr><td><a href="/constructor/boolFalse">boolFalse</a></td><td>Constructor may be interpreted as a <strong>boolean</strong><code>false</code> value.</td></tr><tr><td><a href="/constructor/boolTrue">boolTrue</a></td><td>The constructor can be interpreted as a <strong>boolean</strong><code>true</code> value.</td></tr></tbody></table>
