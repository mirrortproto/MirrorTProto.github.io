...
The TCP transport is implemented simply by sending the payloads generated by the chosen [MTProto transport](/mtproto/mtproto-transports/) over a plain TCP socket on ports 80, 443, 5222 or other (a different port number may be returned by [help.getConfig](https://core.telegram.org/method/help.getConfig)).  
